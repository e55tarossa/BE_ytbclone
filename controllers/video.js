...
export const getByTags = async (req, res, next) => {
  //query là lấy những thứ sau ? localhost:8800/api/videos/tags?tags=js,py,c
...
export const search = async (req, res, next) => {
  ...
  try {
    //Search theo title bằng regex của mongo option i khong phan biệt hoa thường
